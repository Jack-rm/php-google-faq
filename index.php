...
Consigli:
Aiutatevi con la documentazione ufficiale di php per tutte le funzionalità che ritenete necessario utilizzare.
Non perdete tempo con la parte estetica finché non avete completato la logica in PHP, è questo il focus dell'esercizio non la rappresentazione.
...
<?php 
    ...
    $headerItems = [
        'logo' => "https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo.png",
        'sectionName' => 'Privacy e termini',
    ];

    $navBar = [
        'navBar_1' => "Introduzione",
        'navBar_2' => "Norme sulla privacy",
        'navBar_3' => "Termini di Servizio",
        'navBar_4' => "Tecnologie",
        'navBar_5' => "Domande Frequenti",
    ];
